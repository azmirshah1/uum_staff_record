...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con,"update employeedetail set EmpPassword='$password'  where  EmpEmail='$email' && EmpSecurityCode='$empid' ");
   if($query)
   {
...
<head>
  ...
  <meta name="viewport" content="UUM Record management System in php and mysql">
  <meta name="description" content="UUM Record management System in php and mysql">
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    <h3 align="center" style="color: black; padding-top: 2%">UUM RECORD MANAGEMENT SYSTEM</h3>
