...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con,"select ID from employeedetail where  EmpEmail='$Email' and EmpSecurityCode='$empid' ");
  ...
  <div class="container">
    ...
    echo $msg;
                  ...
                  <form class="user" method="post" action="">
                    ...
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" id="empid" name="empid" placeholder="Enter Security Code" required="true">
                    </div>
