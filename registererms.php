...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into employeedetail(EmpFname, EmpLName, EmpSecurityCode, EmpEmail,  EmpPassword) value('$FName', '$LName', '$SecurityCode', '$Email', '$Password' )");
    if ($query) {
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
  <h3 align="center" style="color: black; padding-top: 1%">UUM RECORD MANAGEMENT SYSTEM</h3>
              ...
              <form class="user" name="register" method="post" onsubmit="return checkpass();">
                <div class="form-group row">
                 ...
                 <div class="form-group">
                  <input type="password" class="form-control form-control-user" id="SecurityCode" name="SecurityCode" placeholder="Enter Your Employee Code" pattern="[0-9]+" required="true">
                </div>
                <div class="form-group">
